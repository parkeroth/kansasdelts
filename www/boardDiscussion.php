...
<script type="text/javascript">
	...
	$(function() {
		$("#updateButtonCurrent").click(function() {
			...
			var URL = 'boardDiscussion.php?currentDate=' + year + '-' + month + '-' + day;
...
<h1>Board Minutes - <?php echo $date;?></h1>
	<form>
		<p>
			...
			<input type="button" value="Edit" onclick="javascript:MM_openBrWindow('boardDiscussion.php?date=<?php echo $timeString; ?>','','width=500,height=400, scrollbars=1');" />
			</p>
	</form>

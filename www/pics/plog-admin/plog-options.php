			...
			<div id="options-section">
				<table class="option-table" cellspacing="0">
					<tr class="alt">
						...
						<td class="right"><input size="40" type="text" id="gallery_name" name="gallery_name" value="'.stripslashes($config['gallery_name']).'" readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="left"><label for="gallery_url">'.plog_tr('Gallery URL').':</label></td>
						<td class="right"><input size="40" type="text" id="gallery_url" name="gallery_url" value="'.stripslashes($config['gallery_url']).'" readonly="readonly" /></td>
					</tr>
				</table>';
...
/*
 ################
 Since we're using our own login system, we don't want them to be able to mess with the admin
 login system for this thing, not that it really matters anyway
 ################
			<h1>'.plog_tr('Admin').'</h1>

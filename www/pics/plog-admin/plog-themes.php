...
$disabled = "\n\n\t\t" . '<div class="info">
			...
			<p class="no-margin-top">'.plog_tr('Theme changing has been disabled.  If you were to change a theme, it\'d probably jack with our layout too much, so as it is, this will have to do.').'</p>';

display($disabled, 'themes');

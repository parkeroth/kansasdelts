...
<form enctype="multipart/form-data" id="shUsers" name="shUsers" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
...
Sample of displaying the resulting value with a date format of dd.mm.yyyy:
<br> 

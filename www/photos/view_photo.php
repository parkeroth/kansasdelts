...
?>
<h2 class="photo_image_title"><?php echo $photo_info['title']; ?></h2>

<div id="individual_photo">
    <img src="<?php echo $photo_src; ?>" alt="<?php echo $photo_info['title']; ?>" />
</div>

<a href="<?php echo $photo_info['urls']['url']['photopage'] ?>" title="View this image on Flickr">[ View This Image on Flickr ]</a>
